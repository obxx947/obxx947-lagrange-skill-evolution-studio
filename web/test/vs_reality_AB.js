...
(async () => {
  ...
  /* ---- 逐舰种输出对比（游戏数来自你图里那张表） ---- */
  const GAME_PER = {
    /* ★ 2026-09-27 由 138 张战报滚动截图 OCR 得到（游戏第 1 场，逐【型号】一行）
       键 = 引擎/ship_database 的舰名；值 = 战报那一行的 对舰/对空/维修 */
    '太阳鲸-武装战略航空母舰':   { s: 1268000, a: 2150,    r: 0 },
    '猎兵级-重型载机巡洋舰':     { s: 2482,    a: 33480,   r: 0 },
    '狩猎者级-载机巡洋舰':       { s: 1298,    a: 52700,   r: 0 },
    '康纳马拉混沌级-高速等离子体巡洋舰': { s: 1468000, a: 98330, r: 0 },
    '游骑兵级-重型离子炮巡洋舰':  { s: 1250000, a: null,    r: 0 },
    '枪骑兵级-区域防空驱逐舰':    { s: 0,       a: 2370,    r: 0 },
    '星云追逐者-脉冲炮艇':       { s: 353100,  a: 20910,   r: 0 },
    'CV-T800型-脉冲炮艇':      { s: 312800,  a: null,    r: 0 },
    '林鸮A100型-联合攻击机':     { s: 411100,  a: null,    r: 0 },
    '海氏追随者型-脉冲攻击机':    { s: 318900,  a: null,    r: 0 },
    '维塔斯A021-重型攻击机':     { s: 689700,  a: 18150,   r: 0 },
    '维塔斯-B010-轰炸机':       { s: 985100,  a: null,    r: 0 },
    '刺鳐-鱼雷轰炸机':          { s: 291400,  a: null,    r: 0 },
    '索姆河之影-装甲飞行坦克':    { s: 177900,  a: null,    r: 0 },
    'CV3000级-快速航空母舰':     { s: 70300,   a: 11400,   r: 0 },
    '天枢级-支援航空母舰':       { s: 1107,    a: 99510,   r: 808600 },
    '乌拉诺斯之矛':             { s: 526200,  a: 67130,   r: 0 },
    '开阳级-机动驱逐舰':         { s: 6702,    a: null,    r: 0 },
    'FG300型-侦察护卫舰':       { s: 6,       a: 1525,    r: 0 },
    '海尔波普-维修支援护航艇':    { s: 0,       a: null,    r: 163800 },
    '海尔波普-系统支援护航艇':    { s: 0,       a: null,    r: 368800 },
    '天玑-重型护航艇':          { s: 114400,  a: null,    r: 0 },
    '天玑-攻击护航艇（攻击B型）':  { s: 70360,   a: null,    r: 0 },
    'SC002型-量子侦察机':       { s: 5556,    a: null,    r: 0 },
    'BR050-多用途轰炸机-B（防御型）': { s: 45270, a: null,    r: 0 },
    '理智A101-战斗攻击机-B':     { s: 26650,   a: null,    r: 0 },
    '雷火V022-轻型战斗机':       { s: 0,       a: 79270,   r: 0 }
