...
const IDS = ["tianxuan","lizhi","leihuoV022","leihuoV022-C","br050","br050-C","at021","at021-B","B192-newland","vitas-B010","vitas-A021","tianji","nebula-corvette","hive-guardian","ship-ato21c","linxiao","haishi","sc002","sun-whale","zhizhan","connemara-A"];
db.filter(s => IDS.includes(s.id)).forEach(s => Object.keys(s.modules || {}).filter(k => !k.startsWith('_')).forEach(k => {
  const m = s.modules[k];
